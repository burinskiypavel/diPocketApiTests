...
public class HomePageWithAlreadyExistClientTest extends BaseTest {
    ...
    public void test_ClientServices_v1_homePage_AutintificateMobileApp() throws SQLException, ClassNotFoundException {
        app.getDbHelper().deleteClientDeviceFromDB(app.getDbHelper().prop.getProperty("mobile.login.deviceuuid"));
        given()
                .header("deviceuuid", app.getDbHelper().prop.getProperty("mobile.login.deviceuuid"))
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .header("authorization", app.getDbHelper().prop.getProperty("mobile.login.authorizationBasic"))
                ...
                .body("{\n" +
                        ...
                        "  \"devType\" : \"android\",\n" +
                        "  \"deviceUUID\" : \""+ app.getDbHelper().prop.getProperty("mobile.login.deviceuuid")+"\",\n" +
                        "  \"appVersion\" : \"2.2.7\"\n" +
                        "}")
                .when()
    ...
    public void test_ClientServices_v1_homePage_AutintificateMobileApp_() throws SQLException, ClassNotFoundException {
        String loginSMSCode = app.getDbHelper().getLoginSMSFromDB("380980316499", app.getDbHelper().prop.getProperty("mobile.login.deviceuuid"));
        Response res =  given()
                .header("deviceuuid", app.getDbHelper().prop.getProperty("mobile.login.deviceuuid"))
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .header("authorization", app.getDbHelper().prop.getProperty("mobile.login.authorizationBasic"))
