...
public class RegistrationTest extends BaseTest {
    ...
    public void test_ClientServices_v1_references_availableCountries(){
        ...
        public void test_ClientServices_v1_references_languages(){
            given()
                    ...
                    .header("site", prop.getProperty("mobile.site"))
                    .when()
                    .get(prop.getProperty("devUrl")+"references/languages")
                    .then()
                    .statusCode(200)
    ...
    public void test_ClientServices_v1_references_appConfig(){
        given()
                ...
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .get(prop.getProperty("devUrl")+"references/appConfig?platform=android&version=2.2.9&langCode=rus")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_loadSavePointData2() {
        given()
                ...
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .get(prop.getProperty("devUrl")+"userRegistration/loadSavePointData2?devUUID="+prop.getProperty("mobile.registration.deviceuuid")+"")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        ...
        given()
                ...
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .get(prop.getProperty("devUrl")+"references/verifyPhone?phone="+prop.getProperty("mobile.registration.phoneNumber")+"")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_references_topCountries() {
        Response res = given()
                ...
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .get(prop.getProperty("devUrl")+"references/topCountries?langID=4");
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("devUrl")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7ae86ada")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2_() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("devUrl")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@c248ad3")
                .then()
                .statusCode(200)
                .log().all();
    ...
    public void test_ClientServices_v1_userRegistration_clientImage() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("devUrl")+"userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@4ea8388f")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2__() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("devUrl")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@23a8b3b2")
                .then()
                .statusCode(200)
                .log().all();
    }
        ...
        public void test_ClientServices_v1_userRegistration_clientImage__() {
            given()
                    ...
                    .body("{\n" +
                            ...
                            "}")
                    .when()
                    .put(prop.getProperty("devUrl")+"userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@65a534c2")
                    .then()
                    .statusCode(200)
                    .log().all();
        }
    ...
    public void test_ClientServices_v1_references_questions() {
        given()
                ...
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .get(prop.getProperty("devUrl")+"references/questions?langId=4&countryId=616")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2___() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("devUrl")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7f2e6e63")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_sendTermsAndConditions() {
        given()
                ...
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .put(prop.getProperty("devUrl")+"userRegistration/sendTermsAndConditions?deviceUUID="+prop.getProperty("mobile.registration.deviceuuid")+"")
                .then()
                .statusCode(200)
                .log().all();
    }
...
//                        "  \"pin\" : \"******\",\n" +
                        ...
                        "}")
                .when()
                .post(prop.getProperty("devUrl")+"userRegistration/registerNewClient2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@382cf589")
                .then()
                .statusCode(200)
