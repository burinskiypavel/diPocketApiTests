...
public class RegistrationTest extends BaseTest {
    ...
    public void test_ClientServices_v1_references_availableCountries() throws SQLException, ClassNotFoundException {
        ...
        given()
                ...
                .when()
                .get( prop.getProperty("mobile.base.url")+"references/availableCountries?langID=4")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_sendSMSCodeForPhone(){
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post(prop.getProperty("mobile.base.url")+"userRegistration/sendSMSCodeForPhone?langId=4&phoneNum="+prop.getProperty("mobile.registration.phoneNumber")+"")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        smsCode = getSMSCodeFromDB(prop.getProperty("mobile.registration.phoneNumber"));
        given()
                .header("deviceuuid", prop.getProperty("mobile.registration.deviceuuid"))
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .get(prop.getProperty("mobile.base.url")+"references/verifyPhone?phone="+prop.getProperty("mobile.registration.phoneNumber")+"")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_checkPhoneAndLoadSavePoint() {
        given()
                ...
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .get(prop.getProperty("mobile.base.url")+"userRegistration/checkPhoneAndLoadSavePoint?langId=4&phoneNum="+prop.getProperty("mobile.registration.phoneNumber")+"&code="+smsCode+"")
                .then()
                .statusCode(200)
                .body("isInvited", equalTo(false))
    ...
    public void test_ClientServices_v1_references_questions() {
        given()
                ...
                .header("site", prop.getProperty("mobile.site"))
                .when()
                .get(prop.getProperty("mobile.base.url")+"references/questions?langId=4&countryId=616")
                .then()
                .statusCode(200)
