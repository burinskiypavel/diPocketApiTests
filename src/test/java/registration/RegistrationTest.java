...
public class RegistrationTest extends BaseTest {
    ...
    public void test_ClientServices_v1_references_availableCountries() throws SQLException, ClassNotFoundException {
        app.getDbHelper().deleteClientFromDB(app.getDbHelper().prop.getProperty("mobile.registration.phoneNumber"));
        given()
                .header("deviceuuid", app.getDbHelper().prop.getProperty("mobile.registration.deviceuuid"))
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .when()
                .get( app.getDbHelper().prop.getProperty("mobile.base.url")+"references/availableCountries?langID=4")
                .then()
                .statusCode(200)
        ...
        public void test_ClientServices_v1_references_languages(){
            given()
                    ...
                    .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                    .when()
                    .get(app.getDbHelper().prop.getProperty("mobile.base.url")+"references/languages")
                    .then()
                    .statusCode(200)
    ...
    public void test_ClientServices_v1_references_appConfig(){
        given()
                ...
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .when()
                .get(app.getDbHelper().prop.getProperty("mobile.base.url")+"references/appConfig?platform=android&version=2.2.9&langCode=rus")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_loadSavePointData2() {
        given()
                ...
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .when()
                .get(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/loadSavePointData2?devUUID="+ app.getDbHelper().prop.getProperty("mobile.registration.deviceuuid")+"")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_sendSMSCodeForPhone(){
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/sendSMSCodeForPhone?langId=4&phoneNum="+ app.getDbHelper().prop.getProperty("mobile.registration.phoneNumber")+"")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        smsCode = app.getDbHelper().getSMSCodeFromDB(app.getDbHelper().prop.getProperty("mobile.registration.phoneNumber"));
        given()
                .header("deviceuuid", app.getDbHelper().prop.getProperty("mobile.registration.deviceuuid"))
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .when()
                .get(app.getDbHelper().prop.getProperty("mobile.base.url")+"references/verifyPhone?phone="+ app.getDbHelper().prop.getProperty("mobile.registration.phoneNumber")+"")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_references_topCountries() {
        Response res = given()
                ...
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .when()
                .get(app.getDbHelper().prop.getProperty("mobile.base.url")+"references/topCountries?langID=4");
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        given()
                ...
                .body("{\n" +
                        "  \"deviceUUID\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.deviceuuid")+"\",\n" +
                        "  \"langId\" : 4,\n" +
                        "  \"mainPhone\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.phoneNumber")+"\",\n" +
                        "  \"stepNo\" : 1,\n" +
                        ...
                        "}")
                .when()
                .put(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7ae86ada")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_checkPhoneAndLoadSavePoint() {
        given()
                ...
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .when()
                .get(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/checkPhoneAndLoadSavePoint?langId=4&phoneNum="+ app.getDbHelper().prop.getProperty("mobile.registration.phoneNumber")+"&code="+smsCode+"")
                .then()
                .statusCode(200)
                .body("isInvited", equalTo(false))
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2_() {
        given()
                ...
                .body("{\n" +
                        "  \"deviceUUID\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.deviceuuid")+"\",\n" +
                        "  \"langId\" : 4,\n" +
                        "  \"firstName\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.firstName")+"\",\n" +
                        "  \"lastName\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.lastName")+"\",\n" +
                        "  \"mainPhone\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.phoneNumber")+"\",\n" +
                        "  \"countryId\" : 616,\n" +
                        "  \"currencyId\" : 985,\n" +
                        ...
                        "}")
                .when()
                .put(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@c248ad3")
                .then()
                .statusCode(200)
                .log().all();
    ...
    public void test_ClientServices_v1_userRegistration_clientImage() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@4ea8388f")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2__() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@23a8b3b2")
                .then()
                .statusCode(200)
                .log().all();
    }
        ...
        public void test_ClientServices_v1_userRegistration_clientImage__() {
            given()
                    ...
                    .body("{\n" +
                            ...
                            "}")
                    .when()
                    .put(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@65a534c2")
                    .then()
                    .statusCode(200)
                    .log().all();
        }
    ...
    public void test_ClientServices_v1_references_questions() {
        given()
                ...
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .when()
                .get(app.getDbHelper().prop.getProperty("mobile.base.url")+"references/questions?langId=4&countryId=616")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2___() {
        given()
                ...
                .body("{\n" +
                        ...
                        "  \"lastName\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.lastName")+"\",\n" +
                        "  \"mainPhone\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.phoneNumber")+"\",\n" +
                        "  \"email\" : \""+ app.getDbHelper().prop.getProperty("mobile.registration.email")+"\",\n" +
                        "  \"countryId\" : 616,\n" +
                        "  \"currencyId\" : 985,\n" +
                        "  \"birthDate\" : \"715611173985\",\n" +
                        "  \"residenceCountryId\" : 616,\n" +
                        ...
                        "}")
                .when()
                .put(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7f2e6e63")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_sendTermsAndConditions() {
        given()
                ...
                .header("site", app.getDbHelper().prop.getProperty("mobile.site"))
                .when()
                .put(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/sendTermsAndConditions?deviceUUID="+ app.getDbHelper().prop.getProperty("mobile.registration.deviceuuid")+"")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_registerNewClient2(){
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post(app.getDbHelper().prop.getProperty("mobile.base.url")+"userRegistration/registerNewClient2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@382cf589")
                .then()
                .statusCode(200)
