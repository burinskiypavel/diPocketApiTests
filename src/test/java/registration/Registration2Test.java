...
public class Registration2Test extends BaseTest {
    String smsCode = null;
    ...
    public void test_ClientServices_v1_references_availableCountries(){
         given()
                .header("deviceuuid", prop.getProperty("deviceuuid"))
                .header("site", prop.getProperty("site"))
                .when()
                .get( prop.getProperty("devUrl")+"references/availableCountries?langID=4")
                .then()
                .statusCode(200)
        ...
        public void test_ClientServices_v1_references_languages(){
            given()
                    ...
                    .when()
                    .get(Properties.devUrl+"references/languages")
                    .then()
                    .statusCode(200)
    ...
    public void test_ClientServices_v1_references_appConfig(){
        given()
                ...
                .header("site", Properties.site)
                .when()
                .get(Properties.devUrl+"references/appConfig?platform=android&version=2.2.9&langCode=rus")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_loadSavePointData2() {
        given()
                ...
                .header("site", Properties.site)
                .when()
                .get(Properties.devUrl+"userRegistration/loadSavePointData2?devUUID="+Properties.deviceuuid+"")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_sendSMSCodeForPhone(){
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post(Properties.devUrl+"userRegistration/sendSMSCodeForPhone?langId=4&phoneNum=380980316499")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        smsCode = getSMSCodeFromDB("380980316499");
        given()
                .header("deviceuuid", Properties.deviceuuid)
                .header("site", Properties.site)
                .when()
                .get(Properties.devUrl+"references/verifyPhone?phone=380980316499")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        given()
                ...
                .body("{\n" +
                        "  \"deviceUUID\" : \""+Properties.deviceuuid+"\",\n" +
                        "  \"langId\" : 4,\n" +
                        ...
                        "}")
                .when()
                .put(Properties.devUrl+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7ae86ada")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_checkPhoneAndLoadSavePoint() {
        given()
                ...
                .header("site", Properties.site)
                .when()
                .get(Properties.devUrl+"userRegistration/checkPhoneAndLoadSavePoint?langId=4&phoneNum=380980316499&code="+smsCode+"")
                .then()
                .statusCode(200)
                .body("isInvited", equalTo(false))
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2_() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(Properties.devUrl+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@c248ad3")
                .then()
                .statusCode(200)
                .log().all();
    ...
    public void test_ClientServices_v1_userRegistration_clientImage() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(Properties.devUrl+"userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@4ea8388f")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2__() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(Properties.devUrl+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@23a8b3b2")
                .then()
                .statusCode(200)
                .log().all();
    }
        ...
        public void test_ClientServices_v1_userRegistration_clientImage__() {
            given()
                    ...
                    .body("{\n" +
                            ...
                            "}")
                    .when()
                    .put(Properties.devUrl+"userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@65a534c2")
                    .then()
                    .statusCode(200)
                    .log().all();
        }
    ...
    public void test_ClientServices_v1_references_questions() {
        given()
                ...
                .header("site", Properties.site)
                .when()
                .get(Properties.devUrl+"references/questions?langId=4&countryId=616")
                .then()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2___() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(Properties.devUrl+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7f2e6e63")
                .then()
                .statusCode(200)
                .log().all();
    }
    ...
    public void test_ClientServices_v1_userRegistration_sendTermsAndConditions() {
        given()
                ...
                .header("site", Properties.site)
                .when()
                .put(Properties.devUrl+"userRegistration/sendTermsAndConditions?deviceUUID="+Properties.deviceuuid+"")
                .then()
                .statusCode(200)
                .log().all();
    }
...
//                        "  \"pin\" : \"******\",\n" +
                        ...
                        "}")
                .when()
                .post(Properties.devUrl+"userRegistration/registerNewClient2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@382cf589")
                .then()
                .statusCode(200)
