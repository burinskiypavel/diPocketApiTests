...
public class EmailVerificationHelper {
    ...
    public static String getTextFromEmail(String host, String user,
                                          String password, String appPass) throws InterruptedException, MessagingException, IOException {
        String result = "";
        //Thread.sleep(2000);
    ...
    public static List<String> getEmailSenderAndSubject(String user, String password, String appPass) throws InterruptedException, MessagingException, IOException {
        List<String> result = new ArrayList<String>();
        //Thread.sleep(5500);
