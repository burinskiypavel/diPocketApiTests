...
public class EmailIMAPHelper2 {
    public static String getLinkFromEmailAfterRegistration2(String host, String user,
...
//                        }
    ...
    public static void main(String[] args) throws InterruptedException, IOException, MessagingException {
        ...
        String text = getLinkFromEmailAfterRegistration2(host,  username, password);
