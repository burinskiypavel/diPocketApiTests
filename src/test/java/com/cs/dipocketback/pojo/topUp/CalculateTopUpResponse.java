...
public class CalculateTopUpResponse {
    
    private String feeCurrencyCode;
    private Long feeAmount;
    private Boolean feeEnoughFunds;
    
    public CalculateTopUpResponse() {
    }

    public CalculateTopUpResponse(String feeCurrencyCode, Long feeAmount, Boolean feeEnoughFunds) {
