...
public class DiscontuRegistrationTest extends TestBase {
    ...
    public void test_ClientServices_v1_userRegistration_loadSavePointData2() {
        given()
                ...
                .when()
                .get(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/loadSavePointData2")
                .then().log().all()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_sendSMSCodeForPhone(){
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/sendSMSCodeForPhone")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        ...
        given()
                ...
                .when()
                .get(HelperBase.prop.getProperty("mobile.base.url")+"references/verifyPhone")
                .then().log().all()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_references_topCountries() {
        Response res = given()
                ...
                .queryParam("langID", "4")
                .when()
                .get(HelperBase.prop.getProperty("mobile.base.url")+"references/topCountries");
        res.then().log().all();
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_userRegistration_checkPhoneAndLoadSavePoint() {
        given()
                ...
                .when()
                .get(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/checkPhoneAndLoadSavePoint")
                .then().log().all()
                .statusCode(200)
                .body("isInvited", equalTo(false))
    ...
    public void test_ClientServices_v1_userRegistration_clientImage() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/clientImage")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_references_questions() {
        given()
                ...
                .when()
                .get(HelperBase.prop.getProperty("mobile.base.url")+"references/questions")
                .then().log().all()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_sendTermsAndConditions() {
        given()
                ...
                .when()
                .put(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/sendTermsAndConditions")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_userRegistration_registerNewClient2(){
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/registerNewClient2")
                .then().log().all()
                .statusCode(200)
