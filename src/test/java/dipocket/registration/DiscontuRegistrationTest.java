...
public class DiscontuRegistrationTest extends TestBase {
    ...
    public void test_ClientServices_v1_references_availableCountries() throws SQLException, ClassNotFoundException {
        ...
        given()
                .header("deviceuuid", HelperBase.prop.getProperty("mobile.registration.deviceuuid2"))
    ...
    public void test_ClientServices_v1_userRegistration_loadSavePointData2() {
        given()
                ...
                .header("site", HelperBase.prop.getProperty("mobile.site2"))
                .when()
                .get(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/loadSavePointData2?devUUID="+ HelperBase.prop.getProperty("mobile.registration.deviceuuid2")+"")
                .then().log().all()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        given()
                ...
                .body("{\n" +
                        "  \"deviceUUID\" : \""+ HelperBase.prop.getProperty("mobile.registration.deviceuuid2")+"\",\n" +
                        "  \"langId\" : 4,\n" +
    ...
    public void test_ClientServices_v1_userRegistration_sendTermsAndConditions() {
        given()
                ...
                .header("site", HelperBase.prop.getProperty("mobile.site2"))
                .when()
                .put(HelperBase.prop.getProperty("mobile.base.url")+"userRegistration/sendTermsAndConditions?deviceUUID="+ HelperBase.prop.getProperty("mobile.registration.deviceuuid2")+"")
                .then().log().all()
                .statusCode(200);
    }
