...
public class RolesCBOSearchByClientDateOfBirthTests extends TestBase {
    ...
    public void test_BOServices_v1_client_search(){
        app.getBoRequestsHelper().boServices_v1_client_search(cookie, "birthDate",  "1.1.1998", "Jaleel", "Haley", "380667904157", "Shirley32@hotmail.com", Site.GETSBYCARD.toString());
    }
}