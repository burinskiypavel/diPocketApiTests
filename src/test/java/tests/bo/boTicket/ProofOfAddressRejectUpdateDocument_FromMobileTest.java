...
public class ProofOfAddressRejectUpdateDocument_FromMobileTest extends TestBase {
    ...
    @Test(priority = 2)
    public void test_ClientServices_v1_clientProfile_proofOfAddress() {
        given()
    ...
    public void test_BOServices_v1_ticket_take() {
        ...
        assertEquals(actualTypeName, "Proof of address change");
    }

    @Test(priority = 5)
    public void test_BOServices_v1_clientId_changeDoc_reject() {
        app.getBoRequestsHelper().boServices_v1_clientId_changeDoc_reject(cookie, clientId, 3, ticketId);
    }
}