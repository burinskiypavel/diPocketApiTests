...
public class RolesBOUserClientPageUploadSelfiesButtonTests extends TestBase {
    String cookie = null;
    int clientId = 0;
    ...
    public void test_BOServices_v1_user_authentication() throws SQLException, ClassNotFoundException {
        ...
        baseURI = app.BOURL;
        basePath = "BOServices";
        cookie = app.getBoRequestsHelper().boServices_v1_auth_authentication(app.BOuserLogin, app.BOuserPass, "EVGENYA");
    }
    ...
    public void test_BOServices_v1_clientImage_33217_selfie(){
        ...
        assertThat(clientImage_selfies[0].getImageInBase64(), not(containsString(image)));
        assertThat(clientImage_selfies[1].getImageInBase64(), not(containsString(image)));
    }

    @Test(priority = 4)
    public void test_BOServices_v1_clientImage_uploadSelfie(){
        app.getBoRequestsHelper().boServices_v1_clientImage_uploadSelfie(cookie, clientId, image, image);
    }
    ...
    public void test_BOServices_v1_clientImage_33217_selfie_(){
        ...
        assertThat(clientImage_selfies[0].getClientId(), equalTo(clientId));
        assertThat(clientImage_selfies[0].getTypeId(), equalTo(1));
        assertThat(clientImage_selfies[0].getImageInBase64(), containsString(image));
        assertThat(clientImage_selfies[1].getTypeId(), equalTo(4));
        assertThat(clientImage_selfies[1].getImageInBase64(), containsString(image));
    }
