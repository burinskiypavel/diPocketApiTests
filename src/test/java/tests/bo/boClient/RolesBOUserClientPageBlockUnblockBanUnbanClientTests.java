...
public class RolesBOUserClientPageBlockUnblockBanUnbanClientTests extends TestBase {
    ...
    @Test(priority = 5)
    public void test_BOServices_v1_supervisor_clientId_reqList() {
    ...
    public void test_BOServices_v1_user_all() {
        given()
                ...
                .then().log().all()
                .statusCode(200)
                .body("firstName", hasItem("Olga"),
                        "lastName", hasItem("Gocałek-Hepner"),
                        "roleId", hasItem("EXTBO"),
                        "stateId", hasItem(10),
                        "stateName", hasItem("Active"),
                        "username", hasItem("OLGA.GOCALEK"),
                        "phone", hasItem("48508055604"),
                        "email", hasItem("Olga.GOCALEK-HEPNER@sodexo.com"),
    ...
    @Test(priority = 13)
    public void test_BOServices_v1_account_other_client_clientId() {
    ...
    @Test(priority = 15)
    public void test_BOServices_v1_account_client_clientId() {
    ...
    @Test(priority = 19)
    public void test_BOServices_v1_payee_clientId() {
        given()
                .spec(app.requestSpecBO)
                .cookie(cookie)
                .pathParam("clientId", clientId)
    ...
    @Test(priority = 21)
    public void test_BOServices_v1_client_clientId_tiles() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 23)
    public void test_BOServices_v1_ticket_client_clientId() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 25)
    public void test_BOServices_v1_client_clientId_pushMsgs() {
        given()
                .cookie(cookie)
                .pathParam("clientId", clientId)
                .spec(app.requestSpecBO)
    ...
    @Test(priority = 29)
    public void test_BOServices_v1_client_clientId_() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 31)
    public void test_BOServices_v1_client_clientId__() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 32)
    public void test_BOServices_v1_client_clientId_ban_WithoutBlockingClientDevice() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 33)
    public void test_BOServices_v1_client_clientId___() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 34)
    public void test_BOServices_v1_client_clientId_unban() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 35)
    public void test_BOServices_v1_client_clientId____() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 36)
    public void test_BOServices_v1_client_clientId_ban() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 37)
    public void test_BOServices_v1_client_clientId_____() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 38)
    public void test_BOServices_v1_client_clientId_unban_() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
    ...
    @Test(priority = 39)
    public void test_BOServices_v1_client_clientId______() {
        given()
                .spec(app.requestSpecBO)
                .pathParam("clientId", clientId)
                .cookie(cookie)
