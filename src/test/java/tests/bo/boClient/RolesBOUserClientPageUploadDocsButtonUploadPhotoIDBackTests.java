    ...
    public void test_BOServices_v1_clientImage_clientId_docs_() {
        given()
                ...
                .body("clientId", hasItem(clientId),
                        ...
                        "typeName", hasItem("PhotoID Back"),
                        "imageInBase64[2]", equalTo(image));
    }
