...
public class GetsbyRegistrationTest extends TestBase {
    String smsCode = null;
    String countryId = "804";
    String phone = "380980316499";
    String email = "testdipocket2@gmail.com";
    String site = app.mobile_site_getsby;
    int langId = 1;
    String token = "96562175";
    ...
    public void test_WebServices_v1_registration_sendTermsAndConditionsAnonymous() {
        given()
                ...
                .body("{\n" +
                        "  \"email\" : \""+email+"\",\n" +
                        "  \"url\" : \"https://getsby-test.dipocket.org/cabinet?rui=true\",\n" +
                        "  \"site\" : \""+site+"\"\n" +
                        "}\n")
                .when()
