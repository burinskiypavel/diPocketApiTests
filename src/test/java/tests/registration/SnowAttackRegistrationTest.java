...
public class SnowAttackRegistrationTest extends TestBase {
    ...
    public void testEmailLink() throws InterruptedException {
        String link = EmailIMAPHelper.getLinkFromEmailAfterRegistrationSnowAttack(HelperBase.prop.getProperty("mobile.registration.email"), "password1<", "oangitprvdsqwrgh");
