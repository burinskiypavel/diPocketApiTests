...
public class SnowAttackRegistrationTest extends TestBase {
    String smsCode = null;
    ...
    public void test_ClientServices_v1_references_availableCountries() throws SQLException, ClassNotFoundException {
        app.getDbHelper().deleteClientFromDB(app.mobile_registration_phoneNumber, app.mobile_site_snowAttack, prop.getProperty("db.url"));
        given()
    ...
    public void test_ClientServices_v1_userRegistration_sendSMSCodeForPhone(){
        given()
                .spec(app.requestSpecSnowAttackRegistration)
                .queryParam("langId", "4")
                .queryParam("phoneNum", app.mobile_registration_phoneNumber)
                .body("{\n" +
                        "  \"smsNumber\" : 1\n" +
                        "}")
                .when()
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        smsCode = app.getDbHelper().getSMSCodeFromDB(app.mobile_registration_phoneNumber, app.mobile_site_snowAttack, prop.getProperty("db.url"));
        given()
                .spec(app.requestSpecSnowAttackRegistration)
    ...
    public void test_ClientServices_v1_references_topCountries() {
        ...
        res.then().body("topCountries.name", hasItems("Польша", "Великобритания", "Австрия", "Венгрия"));
    }
    ...
    public void testEmailLink() throws InterruptedException {
        String link = EmailIMAPHelper.getLinkFromEmailAfterRegistrationSnowAttack(prop.getProperty("mobile.registration.email"), "password1<", "oangitprvdsqwrgh");
