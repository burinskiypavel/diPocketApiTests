...
public class FestivalRegistrationTest extends TestBase {
    String smsCode = null;
    ...
    public void test_ClientServices_v1_references_availableCountries() throws SQLException, ClassNotFoundException {
        app.getDbHelper().deleteClientFromDB(app.mobile_registration_phoneNumber, "FESTIVAL", prop.getProperty("db.url"));
        given()
                .header("deviceuuid", prop.getProperty("mobile.registration.deviceuuid"))
                .header("site", app.mobile_site_festival)
                .queryParam("langID", "4")
                .when()
                .get( prop.getProperty("mobile.base.url")+"references/availableCountries")
                .then().log().all()
                .statusCode(200)
        ...
        public void test_ClientServices_v1_references_languages(){
            given()
                    ...
                    .header("site", app.mobile_site_festival)
                    .when()
                    .get(prop.getProperty("mobile.base.url")+"references/languages")
                    .then().log().all()
                    .statusCode(200)
    ...
    public void test_ClientServices_v1_references_appConfig(){
        given()
                ...
                .header("site", app.mobile_site_festival)
                .when()
                .get(prop.getProperty("mobile.base.url")+"references/appConfig?platform=android&version=2.2.9&langCode=rus")
                .then().log().all()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_loadSavePointData2() {
        given()
                ...
                .header("site", app.mobile_site_festival)
                .when()
                .get(prop.getProperty("mobile.base.url")+"userRegistration/loadSavePointData2?devUUID="+ prop.getProperty("mobile.registration.deviceuuid")+"")
                .then().log().all()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_userRegistration_sendSMSCodeForPhone(){
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post(prop.getProperty("mobile.base.url")+"userRegistration/sendSMSCodeForPhone?langId=4&phoneNum="+app.mobile_registration_phoneNumber+"")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        smsCode = app.getDbHelper().getSMSCodeFromDB(app.mobile_registration_phoneNumber, "FESTIVAL", prop.getProperty("db.url"));
        given()
                .header("deviceuuid", prop.getProperty("mobile.registration.deviceuuid"))
                .header("site", app.mobile_site_festival)
                .when()
                .get(prop.getProperty("mobile.base.url")+"references/verifyPhone?phone="+app.mobile_registration_phoneNumber+"")
                .then().log().all()
                .statusCode(200)
    ...
    public void test_ClientServices_v1_references_topCountries() {
        Response res = given()
                ...
                .header("site", app.mobile_site_festival)
                .when()
                .get(prop.getProperty("mobile.base.url")+"references/topCountries?langID=4");
        res.then().log().all();
        int statusCode = res.getStatusCode();
        String topCountriesHash = res.path("topCountriesHash").toString();
        assertEquals(statusCode, 200);
        assertEquals(topCountriesHash, "974e68b37308d9e2acc3d13efed6868a384f39ffc3cb8e435b641448a1308c08");
        res.then().body("topCountries.name", hasItems("Польша", "Великобритания", "Австрия", "Украина", "Бельгия", "Болгария",  "Германия", "Хорватия"));
    }
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        given()
                ...
                .body("{\n" +
                        ...
                        "  \"langId\" : 4,\n" +
                        "  \"mainPhone\" : \""+app.mobile_registration_phoneNumber+"\",\n" +
                        "  \"stepNo\" : 1,\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7ae86ada")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_userRegistration_checkPhoneAndLoadSavePoint() {
        given()
                ...
                .header("site", app.mobile_site_festival)
                .when()
                .get(prop.getProperty("mobile.base.url")+"userRegistration/checkPhoneAndLoadSavePoint?langId=4&phoneNum="+app.mobile_registration_phoneNumber+"&code="+smsCode+"")
                .then().log().all()
                .statusCode(200)
                .body("isInvited", equalTo(false))
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2_() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@c248ad3")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_userRegistration_clientImage() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("mobile.base.url")+"userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@4ea8388f")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2__() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@23a8b3b2")
                .then().log().all()
                .statusCode(200);
    }
        ...
        public void test_ClientServices_v1_userRegistration_clientImage__() {
            given()
                    ...
                    .body("{\n" +
                            ...
                            "}")
                    .when()
                    .put(prop.getProperty("mobile.base.url")+"userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@65a534c2")
                    .then().log().all()
                    .statusCode(200);
        }
    ...
    public void test_ClientServices_v1_references_questions() {
        given()
                ...
                .header("site", app.mobile_site_festival)
                .when()
                .get(prop.getProperty("mobile.base.url")+"references/questions?langId=4&countryId="+countryId+"")
                .then().log().all()
                .statusCode(200)
                .body("checkboxList.typeId[0]", equalTo("AGREE_TARIFFS_LABEL"))
                .body("checkboxList.typeId[3]", equalTo("ELECTRONIC_COMMUNICATION"));
    }
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2___() {
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put(prop.getProperty("mobile.base.url")+"userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7f2e6e63")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_userRegistration_sendTermsAndConditions() {
        given()
                ...
                .header("site", app.mobile_site_festival)
                .when()
                .put(prop.getProperty("mobile.base.url")+"userRegistration/sendTermsAndConditions?deviceUUID="+ prop.getProperty("mobile.registration.deviceuuid")+"")
                .then().log().all()
                .statusCode(200);
    }
    ...
    public void test_ClientServices_v1_userRegistration_registerNewClient2(){
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post(prop.getProperty("mobile.base.url")+"userRegistration/registerNewClient2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@382cf589")
                .then().log().all()
                .statusCode(200)
