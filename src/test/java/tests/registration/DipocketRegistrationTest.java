...
public class DipocketRegistrationTest extends TestBase {
    ...
    public void test_ClientServices_v1_references_availableCountries() throws SQLException, ClassNotFoundException {
        ...
        Response response = app.getClientServicesRequestsHelper().сlientServices_v1_references_availableCountries(prop.getProperty("mobile.base.url"), langId);
        response.then().body("countryList.code", hasItems("AU", "MK", "JP"),
                "countryList.name", hasItems("Bulgaria", "Canada", "Japan"));
...
//                        "countryList.name", hasItems("Австралия", "Македония", "Япония"));
        ...
        Response response = app.getClientServicesRequestsHelper().clientServices_v1_references_languages(prop.getProperty("mobile.base.url"), Site.DIPOCKET.toString());
...
//                            "langHash", equalTo("6f17331d1fd95282099858d04b3b7c3032bb3b654fbcfe73774b0e190eb16a08"));
    ...
    public void test_ClientServices_v1_references_appConfig(){
        Response response = app.getClientServicesRequestsHelper().clientServices_v1_references_appConfig(prop.getProperty("mobile.base.url"), "android", "2.2.9", "rus", Site.DIPOCKET.toString());
...
//                        "appParams.isAccountCreationEnabled", equalTo(true));
    ...
    public void test_ClientServices_v1_userRegistration_loadSavePointData2() {
        Response response = app.getClientServicesRequestsHelper().сlientServices_v1_userRegistration_loadSavePointData2(prop.getProperty("mobile.base.url"), prop.getProperty("mobile.registration.deviceuuid"), site);
...
//                .body("value", equalTo(true));
    ...
    public void test_ClientServices_v1_references_topCountries() {
        Response response = app.getClientServicesRequestsHelper().сlientServices_v1_references_topCountries(prop.getProperty("mobile.base.url"), langId, site);
        response.then().body(
                "topCountries.id", hasItems(826, 380, 840),
                "topCountries.code", hasItems("PL", "GB"),
                "topCountries.name", hasItems("Poland", "United Kingdom", "Italy", "Austria", "Ukraine", "Belgium", "Bulgaria", "Hungary"));
//        Response res = given()
//                .spec(app.requestSpecDipocketRegistration)
//                .queryParam("langID", langId)
//                .when()
...
//        res.then().body("topCountries.name", hasItems("Польша", "Великобритания", "Италия", "Австрия", "Украина", "Бельгия", "Болгария", "Венгрия"));
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        ...
        app.getClientServicesRequestsHelper().clientServices_v1_userRegistration_registrationSavePoint2(prop.getProperty("mobile.base.url"), json, site);
...
//                        "smsCode", equalTo(smsCode));
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2_() {
        ...
        regSavepointData2.setDeviceUUID(prop.getProperty("mobile.registration.deviceuuid"));
...
//                .statusCode(200);
    ...
    public void test_ClientServices_v1_userRegistration_clientImage() {
        userRegistrationClientImageRequest.setDeviceUUID(prop.getProperty("mobile.registration.deviceuuid"));
        ...
        app.getClientServicesRequestsHelper().clientServices_v1_userRegistration_clientImage(prop.getProperty("mobile.base.url"), json);
...
//                    .statusCode(200);
    ...
    public void test_ClientServices_v1_references_questions() {
        Response response = app.getClientServicesRequestsHelper().clientServices_v1_references_questions(prop.getProperty("mobile.base.url"), langId, countryId);
...
//                        "checkboxList.typeId[1]", equalTo("ELECTRONIC_COMMUNICATION"));
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2___() {
        regSavepointData2.setEmail(prop.getProperty("mobile.registration.email"));
...
//                .statusCode(200);
    ...
    public void test_ClientServices_v1_userRegistration_sendTermsAndConditions() {
        app.getClientServicesRequestsHelper().clientServices_v1_userRegistration_sendTermsAndConditions(prop.getProperty("mobile.base.url"), prop.getProperty("mobile.registration.deviceuuid"));
//        given()
//                .spec(app.requestSpecDipocketRegistration)
...
//                .statusCode(200);
    ...
    public void test_ClientServices_v1_userRegistration_registerNewClient2(){
        ...
        Response response = app.getClientServicesRequestsHelper().clientServices_v1_userRegistration_registerNewClient2(prop.getProperty("mobile.base.url"), json);
    ...
    public void testEmailLink() throws InterruptedException {
        ...
        given().log().uri().log().headers().log().body()
                ...
                .body("html.body.div.div.div.p", equalTo("You have successfully confirmed your email address"),
                        "html.body.div.div.div.h2", equalTo("Thank you!"));
    }
