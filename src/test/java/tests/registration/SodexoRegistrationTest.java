...
public class SodexoRegistrationTest extends TestBase {
    ...
    public void testEmailLink() throws InterruptedException, SQLException, ClassNotFoundException {
        String link = EmailIMAPHelper.getLinkFromEmailAfterRegistrationSodexo(prop.getProperty("mobile.registration.email"), "password1<");
        ...
        assertTrue(app.getDbHelper().isClientExistInDB(app.mobile_registration_phoneNumber, site));
    }
}