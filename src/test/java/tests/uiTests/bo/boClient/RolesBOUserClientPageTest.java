...
public class RolesBOUserClientPageTest extends UITestBase {
    ...
    public void testRolesBOUserClientPage() throws InterruptedException {
        ...
        app.getUiboHelper().type(By.cssSelector("app-input-number[ng-reflect-name='id'] input.p-inputnumber-input"), "33217");
        app.getUiboHelper().waitFor(By.cssSelector("td[ng-reflect-text='380634413376']"));

        softAssert.assertFalse(!app.getUiboHelper().isElementPresent(By.cssSelector("td[ng-reflect-text='380634413376']")));
        softAssert.assertFalse(!app.getUiboHelper().isElementPresent(By.cssSelector("td[ng-reflect-text='vikarez20@gmail.com']")));

        app.getUiboHelper().click(By.cssSelector("td[ng-reflect-text='380634413376']"));
