...
public class BankTransferTests extends TestBase {
    ...
    public void testBankTransferUpAndGo(String site, String lang, int langId, int id, String email, String pass, int bodyBegin, int bodyEnd, int footerEnd, String expectedEmailSender, String expectedEmailBody, String expectedEmailFooter) throws InterruptedException, MessagingException, IOException {
        postSendBankTransferEmail(langId, site, id);
        ...
        //softAssert.assertEquals(emailSender, expectedEmailSender, "Sender is not correct");
        softAssert.assertEquals(emailBody, expectedEmailBody, "Body is not correct");
        softAssert.assertEquals(emailFooter, expectedEmailFooter, "Footer is not correct");
