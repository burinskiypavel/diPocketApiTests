...
public class BankTransferTests extends TestBase {
    ...
    public Iterator<Object[]> BankTransfer(){
        ...
        list.add(new Object[] {Site.PLAYIT.toString(), Language.EN.toString(), Language.EN.getOurId(), 32732, app.emailsVerificationsEmail, app.emailsVerificationsPass, 36, 156, 157, expectedPlayITSender, "Dear "+app.emailsVerificationsFirstName+", As requested, please find attached your bank transfer confirmation. With kind regards, Customer Service Team", ""+app.SITE_REG+" "+app.site_PlayIT+" is powered by DiPocket UAB, authorised Electronic Money Institution regulated by the Bank of Lithuania (#75) | Licensed by Masterсard for the European Economic Area Upės str. 23, 08128 Vilnius, LT", ""+app.site_PlayIT+" - bank transfer confirmation"});
        list.add(new Object[] {Site.PLAYIT.toString(), Language.HU.toString(), Language.HU.getOurId(), 32732, app.emailsVerificationsEmail, app.emailsVerificationsPass, 36, 174, 175, expectedPlayITSender, "Kedves "+app.emailsVerificationsFirstName+", Kérésének megfelelően, csatolva találhatja a banki utalásról a megerősítő bizonylatot. Üdvözlettel, Ügyfélszolgálati csoport", ""+app.SITE_REG+" Megnyugtatásul tájékoztatjuk, hogy a PlayIT Kártya számládat a DiPocket UAB kezeli, mely vállalatot a Litván Nemzeti Bank elektronikus pénzintézetenként (# 75) engedélyezett és felügyel Upės str. 23, 08128 Vilnius, LT", ""+app.site_PlayIT+" – banki átutalás megerősítése"});
