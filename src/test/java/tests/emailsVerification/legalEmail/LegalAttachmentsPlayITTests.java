...
public class LegalAttachmentsPlayITTests extends TestBase {
    ...
    public void test_clientProfile_getLegalDocumentList() throws SQLException, ClassNotFoundException {
        //app.getDbHelper().deleteClientDeviceFromDB(deviceuuid);
        app.getDbHelper().updateClientLanguageFromDB(email, "4", app.mobile_site_playIt);
        //cliSessionId = login("380633192217", "pasword1", "380633192217-AutoTest-Login", "PlAYIT");
    ...
    public void test_clientProfile_sendLegalInfo2_DipocketPL() throws InterruptedException, MessagingException, IOException, SQLException, ClassNotFoundException {
        app.getDbHelper().updateClientLanguageFromDB(email, "3", app.mobile_site_playIt);
    ...
    public void test_clientProfile_sendLegalInfo2_DipocketUA() throws InterruptedException, MessagingException, IOException, SQLException, ClassNotFoundException {
        app.getDbHelper().updateClientLanguageFromDB(email, "2", app.mobile_site_playIt);
