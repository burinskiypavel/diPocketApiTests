...
public class UpAndGoRegistrationTest extends TestBase {
    String smsCode = null;
    int countryId = 616;
    int currencyId = 985;
    String site = "UPANDGO";
    ...
    public void test_ClientServices_v1_references_languages(){
        given()
                ...
                .then().log().all()
                .statusCode(200)
                .body("languageList.name", hasItems("English", "Українська", "Polski", "Русский"),
                        "languageList.id", hasItems(1, 2, 3, 4),
                        "languageList.code", hasItems("eng", "ukr", "pol", "rus"));
    }
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        ...
        regSavepointData.setMainPhone(app.registrationPhone);
...
//                        "  \"langId\" : 4,\n" +
//                        "  \"mainPhone\" : \""+ app.registrationPhone+"\",\n" +
//                        "  \"stepNo\" : 1,\n" +
...
//                        "}")
    ...
    public void test_ClientServices_v1_references_topCountries() {
        ...
        res.then().body("topCountries.name", hasItems("Польша", "Великобритания", "Украина", "Хорватия"));
    }
...
//                        "}")
    ...
    @Test(priority = 14)
    public void test_ClientServices_v1_userRegistration_loadSavePointData2_() {
        given()
                .spec(app.requestSpecUpAndGoRegistration)
                .queryParam("devUUID", HelperBase.prop.getProperty("mobile.registration.deviceuuid"))
                .when()
                ...
                .log().all()
                .statusCode(200)
                .body("deviceUUID", equalTo(HelperBase.prop.getProperty("mobile.registration.deviceuuid")));
    }
    ...
    public void test_ClientServices_v1_references_questions() {
        given()
                ...
                .body("checkboxList.typeId[0]", equalTo("TERMS_AND_CONDITIONS_PL"),
                        ...
                        "checkboxList.typeId[2]", equalTo("SANTANDER_PERSONAL_DATA"));
    }

    @Test(priority = 18)
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2____() {
        ...
        checkboxContainer2.setTypeId(DATA_PROCESSING);
        checkboxContainer2.setSelected(true);

        CheckboxContainer checkboxContainer3 = new CheckboxContainer();
        checkboxContainer3.setTypeId(SANTANDER_PERSONAL_DATA);
        checkboxContainer3.setSelected(true);

        List<CheckboxContainer> checkboxList = new ArrayList<>();
        checkboxList.add(checkboxContainer1);
        checkboxList.add(checkboxContainer2);
        checkboxList.add(checkboxContainer3);

        regSavepointData.setCheckboxList(checkboxList);
        regSavepointData.setStepNo(5);
        String json = gson.toJson(regSavepointData);
        System.out.println(json);
...
//                        "    \"selected\" : true\n" +
//                        "  }, {\n" +
//                        "    \"typeId\" : \"SANTANDER_PERSONAL_DATA\",\n" +
//                        "    \"selected\" : true\n" +
//                        "  } ],\n" +
//                        "  \"address1\" : {\n" +
//                        "    \"typeId\" : 0,\n" +
