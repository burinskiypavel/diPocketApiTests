...
public class SodexoRegistrationTest extends TestBase {
    ...
    public void test_ClientServices_v1_references_availableCountries() throws SQLException, ClassNotFoundException {
        app.getDbHelper().deleteClientFromDB(HelperBase.prop.getProperty("mobile.registration.phoneNumber"), "SODEXO");
        given()
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        smsCode = app.getDbHelper().getSMSCodeFromDB(HelperBase.prop.getProperty("mobile.registration.phoneNumber"), "SODEXO");
        given()
                .header("deviceuuid", HelperBase.prop.getProperty("mobile.registration.deviceuuid"))
                .header("site", HelperBase.prop.getProperty("mobile.site.discontu"))
                .when()
