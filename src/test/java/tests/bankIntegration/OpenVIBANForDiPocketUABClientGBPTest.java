...
public class OpenVIBANForDiPocketUABClientGBPTest extends TestBase {
    String cookie = null;
    ...
    public void test_BOServices_v1_client_clientID_update() {
        ...
        client_clientId_update.setCurrencyCode("GBP");
...
//                        "}")
    ...
    public void test_CustomerServices_v1_client_register(){
        ...
        clientRegisterRequest.setCurrencyCode(currencyCodeGBP);
...
//                        "}")
    ...
    public void test_CustomerServices_v1_card_create(){
        ...
        cardCreateRequest.setCurrencyCode(currencyCodeGBP);
