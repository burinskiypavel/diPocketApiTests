...
//                .log().all();
        ...
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put("https://dipocket3.intranet:8900/ClientServices/v1/userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7ae86ada")
                .then()
                .statusCode(200)
                .log().all();
        ...
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put("https://dipocket3.intranet:8900/ClientServices/v1/userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@c248ad3")
                .then()
                .statusCode(200)
                .log().all();
        ...
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put("https://dipocket3.intranet:8900/ClientServices/v1/userRegistration/clientImage?value=com.cs.dipocketback.pojo.registration.RegImageData@4ea8388f")
                .then()
                .statusCode(200)
                .log().all();
        ...
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put("https://dipocket3.intranet:8900/ClientServices/v1/userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@23a8b3b2")
                .then()
                .statusCode(200)
                .log().all();
        ...
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put("https://dipocket3.intranet:8900/ClientServices/v1/userRegistration/registrationSavePoint2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@7f2e6e63")
                .then()
                .statusCode(200)
                .log().all();
        ...
        given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post("https://dipocket3.intranet:8900/ClientServices/v1/userRegistration/registerNewClient2?value=com.cs.dipocketback.pojo.registration.RegSavepointData@382cf589")
                .then()
                .statusCode(200)
