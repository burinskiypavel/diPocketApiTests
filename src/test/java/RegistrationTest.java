...
public class RegistrationTest extends BaseTest{
    ...
    public void test_ClientServices_v1_userRegistration_loadSavePointData2() {
        ...
        given()
                ...
                .header("site", Properties.site)
                .when()
                .get(Properties.devUrl+"userRegistration/loadSavePointData2?devUUID=eC10LFCnS1mDsuNoQaa-KH")
                .then()
                .statusCode(200)
...
//                .log().all();
    ...
    public void test_ClientServices_v1_userRegistration_sendTermsAndConditions() {
        given()
                ...
                .header("site", Properties.site)
                .when()
                .put(Properties.devUrl+"userRegistration/sendTermsAndConditions?deviceUUID=eC10LFCnS1mDsuNoQaa-KH")
                .then()
                .statusCode(200)
                .log().all();
    }
