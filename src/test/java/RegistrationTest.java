...
public class RegistrationTest extends BaseTest{
    ...
    public void test_ClientServices_v1_references_availableCountries(){
        ...
        given()
                ...
                .when()
                .get( Properties.devUrl+"references/availableCountries?langID=4")
                .then()
                .statusCode(200)
...
//                .log().all();
    ...
    public void test_ClientServices_v1_references_verifyPhone() throws SQLException, ClassNotFoundException {
        ...
        given()
                ...
                .header("site", Properties.site)
                .when()
                .get(Properties.devUrl+"references/verifyPhone?phone="+Properties.phoneNumber+"")
                .then()
                .statusCode(200)
...
//                .log().all();
    ...
    public void test_ClientServices_v1_userRegistration_registrationSavePoint2() {
        ...
        given()
                ...
                .body("{\n" +
                        ...
                        "  \"langId\" : 4,\n" +
                        "  \"mainPhone\" : \""+Properties.phoneNumber+"\",\n" +
                        "  \"stepNo\" : 1,\n" +
    ...
    public void test_ClientServices_v1_userRegistration_checkPhoneAndLoadSavePoint() {
        ...
        given()
                ...
                .header("site", Properties.site)
                .when()
                .get(Properties.devUrl+"userRegistration/checkPhoneAndLoadSavePoint?langId=4&phoneNum="+Properties.phoneNumber+"&code="+smsCode+"")
                .then()
                .statusCode(200)
                .body("isInvited", equalTo(false))
